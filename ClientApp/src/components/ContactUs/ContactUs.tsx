...
const ContactUs: FC = () => {
  const { isInView, myRef } = useInView({ threshold: 0.3 });

  return (
    <section ref={myRef} id="contactUs" className="contactUs">
      <div className="container">
        ...
        <div className="contactUs__soc">
          <div
            className={
              isInView
                ? "contactUs__soc-item contactUs__soc-item--active"
                : "contactUs__soc-item"
            }
          >
            <a href="#">
        ...
        <div className={isInView ? 'contactUs__address contactUs__address--active' : 'contactUs__address'}>
          <h3>АДРЕС</h3>
          <p>
            Гостиница "Электрон", Андропова пр-т, дом 38, корпус 2, Москва,
            115487
          </p>
          <iframe
